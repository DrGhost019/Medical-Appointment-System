...
import Link from 'next/link'; // 👈 اضافه شدن لینک بهینه Next.js برای سرعت بالاتر و حفظ استیت زوستاند
import { 
  Phone, 
  Mail, 
  Smartphone, 
...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { label: 'لیست پزشکان', href: '/search' }, // فیکس کردن مسیر مطابق صفحه سرچ اصلی
  ...
  // تابع مدیریت ارسال ایمیل خبرنامه به API بک‌آند
  const handleNewsletterSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!email) return;
    
    console.log("ایمیل ثبت شده برای خبرنامه:", email);
    // اینجا می‌توانید متد اتصال به دیتابیس را اضافه کنید:
    ...
    <footer className="w-full bg-white border-t border-[#E7E7E7]" dir="rtl">
      <div className="max-w-[1440px] mx-auto">
        ...
        >
          ...
          <div className="w-[1200px] mx-auto flex items-start justify-between mb-12">

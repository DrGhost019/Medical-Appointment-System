...
import { useBookingStore } from '../../store/bookingStore'; // 👈 اتصال به استور جهت خواندن دیتای گلوبال

// تابع داخلی تبدیل اعداد برای استقلال کامل فایل
...
// هماهنگ با ساختار دیتای واقعی دیتابیس
...
const SelectedDoctorInfo = ({ doctor: propsDoctor }: SelectedDoctorInfoProps) => {
  ...
  // لایه محافظ: اگر هیچ دیتایی نبود، برای جلوگیری از کرش، لودینگ یا متن موقت نشان دهد
  if (!doctor) {
    return (
  ...
  // مدیریت فیلدهای تصویر و مقادیر تهی دیتابیس

// src/app/components/layout/UserProfile.tsx
"use client";
...
interface UserProfileProps {
  userName: string;          // ✅ اجباری
  userAvatar?: string;       // ✅ اختیاری
  onLogout: () => void;      // ✅ اجباری
}

export default function UserProfile({ userName, userAvatar, onLogout }: UserProfileProps) {
  ...
  const avatarSrc = userAvatar || '/assets/logo.png';
